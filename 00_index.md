...
A self-directed data science learning journey, structured as a real research project exploring how humans across cultures describe consciousness, meaning, and the self. Full details in [02_project_brief.md](02_project_brief.md).
...
- **[05_glossary.md](05_glossary.md)** — definitions of terms (parameters, tokens, Colab, tool use, etc.). Single source of truth for concepts.
...
- **Starting a new chat?** Upload this file + [01_working_agreement.md](01_working_agreement.md) first. The assistant can read everything else on demand.
